...
public class GameOver extends JPanel implements ActionListener
{
    ...
    JLabel gameOverLabel = new JLabel("Game Over Mate");
    
    Font flappyFont;
    GameOver() throws FontFormatException, IOException
    {
        this.flappyFont = Font.createFont(Font.TRUETYPE_FONT, new File("src/fonts/flappy-font.ttf"));
